...
parser = argparse.ArgumentParser(description="Sequential oversampled histogram on a NanoAOD sample")
...
helper_0 = ROOT.SequentialOversampledHistogram1D(9, "h_oversampled", "Oversampled nMuon Histogram", 5, -0.5, 4.5)
h_oversampled = rdf.Book(helper_0, ("event", "nMuon"))
helper_1 = ROOT.SequentialOversampledHistogram1D(9, "h_gen_over", "Oversampled Gen Histogram", 5, -0.5, 4.5)
h_gen_over = rdf.Book(helper_1, ("event", "nGenJet"))
helper_2 = ROOT.SequentialOversampledHistogram1D(9, "h_sel_over", "Oversampled nMuon (nJet >= 30) >= 2", 5, -0.5, 4.5)
